...
class MyLine extends Shape {
    ...
    @Override
    String serialize() {
        return String.format("line %d %d %d %d %d %d %d %d %d",p1.x,p1.y,p2.x,p2.y,clr.getRed(),clr.getBlue(),clr.getGreen(),size,move_enable?1:0);
    }
}
...
class MyRectangle extends Shape {
    ...
    @Override
    String serialize() {
        return String.format("rect %d %d %d %d %d %d %d %d %d",p1.x,p1.y,p2.x,p2.y,clr.getRed(),clr.getBlue(),clr.getGreen(),size,move_enable?1:0);
    }
}
class MyRectangleFill extends Shape {
    ...
    @Override
    String serialize() {
        return String.format("rectf %d %d %d %d %d %d %d %d %d",p1.x,p1.y,p2.x,p2.y,clr.getRed(),clr.getBlue(),clr.getGreen(),size,move_enable?1:0);
    }
}
class MyCircle extends Shape {
    ...
    @Override
    String serialize() {
        return String.format("circle %d %d %d %d %d %d %d %d %d",p1.x,p1.y,p2.x,p2.y,clr.getRed(),clr.getBlue(),clr.getGreen(),size,move_enable?1:0);
    }
}
class MyTriangle extends Shape{
    ...
    @Override
    String serialize() {
        return String.format("triangle %d %d %d %d %d %d %d %d %d %d %d",p1.x,p1.y,p2.x,p2.y,clr.getRed(),clr.getBlue(),clr.getGreen(),size,move_enable?1:0,p3.x,p3.y);
    }
}